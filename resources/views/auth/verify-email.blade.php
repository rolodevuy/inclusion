<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        ¡Gracias por registrarte! Antes de continuar, verificá tu correo electrónico haciendo clic en el enlace que te enviamos. Si no recibiste el correo, te enviamos otro.
    </div>

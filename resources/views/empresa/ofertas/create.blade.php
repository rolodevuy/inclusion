<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nueva Oferta de Empleo</h2>
    </x-slot>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <form method="POST" action="{{ route('empresa.ofertas.store') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" rows="5" required
                                    class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm text-base">{{ old('descripcion') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <select id="categoria_laboral_id" name="categoria_laboral_id" required
                                        ...
                                        @foreach($categorias as $cat)
                                            <option value="{{ $cat->id }}" @selected(old('categoria_laboral_id') == $cat->id)>{{ $cat->nombre }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="horario" name="horario" type="text" class="mt-1 block w-full"
                                        :value="old('horario')" placeholder="Ej: Lunes a viernes, 9 a 18 hs" />
                            ...
                            <div>
                                ...
                                <textarea id="requisitos" name="requisitos" rows="3"
                                    class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm text-base">{{ old('requisitos') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="beneficios" name="beneficios" rows="3"
                                    class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm text-base">{{ old('beneficios') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="adaptaciones_disponibles" name="adaptaciones_disponibles" rows="3"
                                    class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm text-base"
                                    placeholder="Describí las adaptaciones que tu empresa puede ofrecer (rampas, software accesible, horarios flexibles, etc.)">{{ old('adaptaciones_disponibles') }}</textarea>
                    ...
                    <div class="mt-6 flex items-center gap-4">
                        <x-primary-button>Publicar oferta</x-primary-button>
                        <a href="{{ route('empresa.ofertas.index') }}" class="text-sm text-gray-600 hover:underline">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
